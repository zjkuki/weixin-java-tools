...
import me.chanjar.weixin.common.util.crypto.IcbcCryptUtil;
...
public class WxMpServiceImpl implements WxMpService {
  ...
  @Override
  public String checkIcbcSignature(String pub_key_path, String priv_key_path, String timestamp, String nonce, String signature) {
    try {
      return IcbcCryptUtil.encrypt(signature, timestamp, pub_key_path, priv_key_path);        
    } catch (Exception e) {
      return "";
    }
  }  
